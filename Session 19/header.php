...
<head>
  ...
  <link rel="stylesheet" href="./vendor/css/skins/_all-skins.min.css">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="list_product_category.php">
            <i class="fa fa-files-o"></i>
            <span>Product Categories</span>
            </a>
        </li>
        <li>
          <a href="index.php?controller=products&action=listProducts">
            <i class="fa fa-files-o"></i>
            <span>Product</span> 
            </a>
        </li>
        <li>
          <a href="index.php?controller=news&action=listNews">
            <i class="fa fa-files-o"></i>
            <span>News</span> 
            </a>
        </li>
